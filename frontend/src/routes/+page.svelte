...
<div class="container min-h-screen mx-auto">
	...
	<div class="absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 mt-16 grid grid-cols-1 gap-16">
		<h1 class="text-center text-8xl text-black font-righteous">Looney</h1>
		<div class="w-full sm:max-w-md shadow-lg bg-red-300 py-5 px-5 rounded-lg place-self-center">
			<RegistrationForm />
		</div>
	</div>
</div>
