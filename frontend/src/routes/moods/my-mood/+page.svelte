...
<div class="bg-white z-20 mx-3 mt-3 px-3 py-3 rounded-lg flex flex-col shadow-lg h-[27rem]">
  <form method="POST" action="?/createRecord">
    <div class="flex justify-center items-center">
      <h2 class="text-xl">How do you feel?</h2>
    </div>
    <div class="flex flex-wrap justify-center items-center overflow-y-scroll overflow-x-hidden h-[7.9rem] py-1">
      ...
      {/each}
   <!-- add new mood button -->
      <a class="p-1" href="/moods/my-mood/createMood"><img src="../src/img/addHabit.png" class="h-9" alt="Add a mood"></a>
    </div>
    ...
    <div class="flex flex-wrap justify-center items-center mt-2 overflow-y-scroll overflow-x-hidden h-[7.9rem] py-1">
      ...
      <a class="p-1" href="/moods/my-mood/createReason"><img src="../src/img/addHabit.png" class="h-9" alt="Add a reason"></a>
    </div>
