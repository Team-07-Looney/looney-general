        ...
        <div class="bg-white rounded-xl px-4 py-5">
          ...
          >
            ...
            <div class="flex items-center justify-center">
              <label for="1" class="justify-center items-center flex flex-col {selectedMoodType === '1' ? 'text-sm font-medium selected-label' : 'text-sm font-medium'}">
                <input id="1" type="radio" value="1" name="mood_type_id" bind:group={selectedMoodType}/>
                <div class="flex flex-col items-center p-1">
                <img src="/src/img/happy.png" alt="Happy heart" class="w-12 h-12">
                </div>
                Positive
              </label>
            </div>
            ...
            <div class="flex items-center justify-center">
              <label for="2" class="justify-center items-center flex flex-col {selectedMoodType === '2' ? 'text-sm font-medium selected-label' : 'text-sm font-medium'}">
              <input id="2" type="radio" value="2" name="mood_type_id" bind:group={selectedMoodType}/>
              <div class="flex flex-col items-center p-1">
              <img src="/src/img/neutral.png" alt="Neutral heart" class="w-12 h-12">
            </div>
                Neutral
              </label>
            </div>
            ...
            <div class="flex justify-center items-center">
              <label for="3" class="justify-center items-center flex flex-col {selectedMoodType === '3' ? 'text-sm font-medium selected-label' : 'text-sm font-medium'}">
              <input id="3" type="radio" value="3" name="mood_type_id" bind:group={selectedMoodType}/>
               <div class="flex flex-col items-center p-1">
                 <img src="/src/img/sad.png" alt="Sad heart" class="w-12 h-12">
                </div>
                Negative
              </label>
            </div>
